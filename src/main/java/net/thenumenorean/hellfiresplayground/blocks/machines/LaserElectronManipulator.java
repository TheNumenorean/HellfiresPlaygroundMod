...
public class LaserElectronManipulator extends BlockContainer {
	...
	public LaserElectronManipulator(int par1) {
		...
		setTextureName("hellfiresplayground:laserElectronManipulator");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, HellfiresPlayground.instance, GuiHandler.LASER_ELECTRON_MANIPULATOR_GUI, world, x, y, z);
		}
