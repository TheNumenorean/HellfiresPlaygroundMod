...
public class RadioisotopicGeneratorTileEntityRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileEntity, double d, double d1, double d2, float f) {
		...
		renderBlock(tileEntityYour, tileEntity.worldObj, tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord,
				HellfiresPlaygroundBlocks.radioisotopic_generator);
		GL11.glPopMatrix();
	...
	public void renderBlock(RadioisotopicGeneratorTileEntity tileEntityYour, World world, int i, int j, int k, Block block) {
		...
		this.bindTexture(new ResourceLocation("hellfiresplayground", tileEntityYour.isOn() ? "textures/blocks/radioisotopicGeneratorOn.png"
