package net.thenumenorean.hellfiresplayground.blocks.machines.replicator;
...
public class Replicator extends BlockContainer {
	...
	public Replicator(int par1) {
		...
		setTextureName("hellfiresplayground:replicator");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, HellfiresPlayground.instance, GuiHandler.REPLICATOR_GUI, world, x, y, z);
		}
