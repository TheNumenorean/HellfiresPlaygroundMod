package net.thenumenorean.hellfiresplayground.entities.projectiles;
...
public class EntityPhaserBolt extends EntityThrowable {
	...
	public static float phaserDamage = 10;
	...
	protected void onImpact(MovingObjectPosition mop) {
		...
		if (mop.entityHit != null)
			mop.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, getThrower()), phaserDamage);
		else {
